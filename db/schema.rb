...
ActiveRecord::Schema.define(version: 2019_04_12_125504) do
  ...
  create_table "comissions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "sale_id"
  ...
  create_table "product_quantities", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "product_id"
    t.integer "quantity"
    t.bigint "user_id"
    t.datetime "created_at", null: false
